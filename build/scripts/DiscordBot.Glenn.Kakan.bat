...
set CLASSPATH=%APP_HOME%\lib\DiscordBot.Glenn.Kakan-1.0.jar;%APP_HOME%\lib\JDA-3.3.1_279.jar;%APP_HOME%\lib\jsoup-1.10.3.jar;%APP_HOME%\lib\jsch-0.1.54.jar;%APP_HOME%\lib\json-simple-1.1.1.jar;%APP_HOME%\lib\miglayout-swing-5.0.jar;%APP_HOME%\lib\pgslookandfeel-1.1.4.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\commons-collections4-4.1.jar;%APP_HOME%\lib\json-20160810.jar;%APP_HOME%\lib\trove4j-3.0.3.jar;%APP_HOME%\lib\jna-4.4.0.jar;%APP_HOME%\lib\nv-websocket-client-2.2.jar;%APP_HOME%\lib\okhttp-3.8.1.jar;%APP_HOME%\lib\junit-4.10.jar;%APP_HOME%\lib\miglayout-core-5.0.jar;%APP_HOME%\lib\okio-1.13.0.jar;%APP_HOME%\lib\hamcrest-core-1.1.jar;%APP_HOME%\lib\slf4j-api-1.7.25.jar
...
:omega
>>>>>>> 68268013f8b4d10df879a4cc4c34f08b9d63fad9
